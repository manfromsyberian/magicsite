...
SECRET_KEY = 'sg&k1_h!hzdf__kdcl*s(4y&*$85b^tpohmo0m75@rs416=how'
...
#MEDIA_ROOT = u'/home/rationhelper/mysite/media'
#MEDIA_URL = '/media/'
#STATIC_ROOT = u'/home/rationhelper/mysite/price/static'
#STATIC_URL = '/static/'

PROJECT_ROOT = u'/home/rationhelper/mysite/' #os.path.dirname(os.path.abspath(__file__))
...
os.path.join(PROJECT_ROOT, 'price/static/'),
